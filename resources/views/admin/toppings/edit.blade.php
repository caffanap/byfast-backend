                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full px-4 lg:w-6/12">
                        <div class="relative w-full mb-3">
                            ...
                            <input name="price" type="text" class="w-full px-3 py-3 text-sm transition-all duration-150 ease-linear bg-white border-0 rounded shadow placeholder-blueGray-300 text-blueGray-600 focus:outline-none focus:ring" value="{{$topping->price}}" placeholder="price" />
                            @error('price')
                            <small class="text-pink-500">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="w-full px-4 lg:w-6/12">
                        <div class="relative w-full mb-3">
                            ...
                            <input name="quota" type="text" class="w-full px-3 py-3 text-sm transition-all duration-150 ease-linear bg-white border-0 rounded shadow placeholder-blueGray-300 text-blueGray-600 focus:outline-none focus:ring" value="{{$topping->quota}}" placeholder="quota" />
                            @error('quota')
                            <small class="text-pink-500">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="w-full px-4 lg:w-6/12">
                        <div class="relative w-full mb-3">
                            ...
                            <input name="active_period" type="text" class="w-full px-3 py-3 text-sm transition-all duration-150 ease-linear bg-white border-0 rounded shadow placeholder-blueGray-300 text-blueGray-600 focus:outline-none focus:ring" value="{{$topping->active_period}}" placeholder="active_period" />
                            @error('active_period')
                            <small class="text-pink-500">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="w-full px-4 lg:w-6/12">
                        <div class="relative w-full mb-3">
                            ...
                            <textarea name="description" placeholder="Deskripsi" class="w-full px-3 py-3 text-sm transition-all duration-150 ease-linear bg-white border-0 rounded shadow placeholder-blueGray-300 text-blueGray-600 focus:outline-none focus:ring">{{$topping->description}}</textarea>
                            @error('description')
                            <small class="text-pink-500">{{ $message }}</small>
                            @enderror
                        </div>
