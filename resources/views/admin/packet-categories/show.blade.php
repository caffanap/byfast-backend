        ...
        <div class="rounded-t mb-0 px-4 py-3 border-0">
            <div class="flex flex-wrap items-center">
                <div class="flex justify-between relative w-full px-4 max-w-full flex-grow flex-1">
                    ...
                    <a href="{{route('admin.packet-categories.create')}}" class="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150">
                        Add
                    </a>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">
                            <div class="flex p-2 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
                                <a href="{{ route('admin.packet-categories.edit',$id) }}" class="p-1 px-2 mx-1 text-xs text-white bg-yellow-500 rounded-md">Edit</a>
                                <form action="{{ route('admin.packet-categories.destroy', $id) }}" method="POST">
                                    @csrf
                                    @method("DELETE")
