                    ...
                    <tr>
                        ...
                        <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">
                            <div class="flex p-2 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
                                <a href="{{ route('admin.packets.show',$id) }}" class="p-1 px-2 mx-1 text-xs text-white bg-green-500 rounded-md">Show</a>
                                <a href="{{ route('admin.packets.edit',$id) }}" class="p-1 px-2 mx-1 text-xs text-white bg-yellow-500 rounded-md">Edit</a>
                                <form action="{{ route('admin.packets.destroy', $id) }}" method="POST">
                                    @csrf
                                    @method("DELETE")
